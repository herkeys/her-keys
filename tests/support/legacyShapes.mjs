...
/**
 * Roots v4 introduced. The last two are Feature 11's (Me / Rebuild), added to the v4 shape later with a `[]` default rather than a
 * new envelope version, so no earlier version ever stored them either.
 */

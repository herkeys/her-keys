...
describe('HA-001 — the inventory of sync-capable canonical kinds', () => {
  test('31 kinds: 29 are pushed, and exactly the two server-written kinds are pull-only', () => {
    // 28 + `member` (a child; HK-FEATURE-05, owner checkpoint OC-01) + HK-FEATURE-11's two (rebuildFocus, rebuildFocusLink), both
    // owner-private and client-written. The account holder's own member row is not a kind of ours.

...
-- 34 from Build 4 (IR01, F08 and F05 add none), plus HK-FEATURE-11's two: rebuild_focuses and rebuild_focus_links.
SELECT CASE WHEN count(*) = 36 THEN 'PASS' ELSE 'FAIL' END
       || ' | 36 application tables exist after the migrations (34 + the two HK-FEATURE-11 tables) (' || count(*)::text || ')'
